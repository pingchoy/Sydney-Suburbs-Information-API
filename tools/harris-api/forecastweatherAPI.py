...
parser.add_argument('order', choices=list(column for column in weather_model.keys()))
...
@api.route('/suburbs/forecastWeather')
...
if __name__ == '__main__':
    ...
    weatherdf = pd.read_csv('forecast_weather_suburb.csv')
